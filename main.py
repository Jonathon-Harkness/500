...
c.execute("CREATE TABLE IF NOT EXISTS SERVER "
          "(GUILD_ID INTEGER PRIMARY KEY, BALL_STATUS TEXT, BALL_VALUE INTEGER, THROW_TYPE TEXT, TIME_ACTIVE DATETIME, CURRENT_THROWER INTEGER)")
c.execute("CREATE TABLE IF NOT EXISTS PLAYER (GUILD_ID INTEGER, PLAYER_ID INTEGER, POINTS INTEGER, STATUS_EFFECT TEXT, USERNAME TEXT, NICKNAME TEXT)")
conn.commit()
